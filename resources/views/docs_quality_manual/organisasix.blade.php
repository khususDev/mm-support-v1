<div id="struktur" class="tab-content-custom m-4">
            ...
            <div class="col-md-12">
                <div class="col-3">
                    ...
                    <label class="btn btn-outline-primary btn-sm w-100 mb-2 text-center">
                        Choose Files
                        <input type="file" id="filesDocumentOrganisasi" multiple hidden> <span
                            id="countFilesDocumentOrganisasi" class="text-muted small d-block">0 files</span>
                    </label>

                </div>

                <div class="border rounded p-2">
                    <div id="previewDocumentOrganisasi" class="mt-2 small file-grid">

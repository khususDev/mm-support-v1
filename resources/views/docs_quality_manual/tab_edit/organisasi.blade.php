        ...
        <div class="col-md-12">
            <div class="col-3">
                ...
                <label class="btn btn-outline-primary btn-sm w-100 mb-2 text-center">
                    Choose Files
                    <input type="file" id="filesDocumentOrganisasi" name="filesDocumentOrganisasi[]" multiple hidden>
                    <span id="countFilesDocumentOrganisasi" class="text-muted small d-block">0 files</span>
                </label>

            </div>
            <div class="border rounded p-0">
                <label for="" style="color:blue; margin-left: 2vh">New Document Upload</label>
                <div id="previewDocumentOrganisasi" class="m-2 small">
                </div>
            </div>
            {{-- Preview File Lama --}}
            <div class="border rounded p-2 mt-3">
                <h6 class="text-secondary">Existing Document</h6>
                <div id="previewExistingDocumentOrganisasi" class="mt-2 small file-grid">
                    @foreach ($organisasi as $file)
                        @php

            ...
            <div class="card">
                <div class="card p-3">
                    <div class="row ml-3 mr-3">
                        <i class="fas fa-file-signature mt-2" style="color: #020d71; font-size: 20px;"></i>
                                    ...
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td class="td">
                                                @switch($item->jenis)
                                                    @case('Diagram')
                                                        <span style="color: #031692; font-weight: bold;">Diagram</span>
                                                    @break

                                                    @case('Formulir')
                                                        <span style="color: #d57b06; font-weight: bold;">Formulir</span>
                                                    @break

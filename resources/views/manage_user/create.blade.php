...
@section('main')
    <div class="row">
        <div class="col-12">
            <div class="card p-3">
                <div class="card m-3">
                    <p class="title-body">CREATE USERS</p>
                </div>
                <div class="row p-2">
                    <div class="card-body p-0">
                        <form action="{{ route('mng_user.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-xl">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <input type="email" id="defaultFormControlInput" class="form-control"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="basic-default-phone" name="phone"
                                                    class="form-control phone-mask" value="{{ old('phone') }}">
                                                @error('phone')
                                                    <small>{{ $message }}</small>
                                                @enderror
                                            </div>
